...
(1, 'chemistry', '2022-04-03 20:14:04');
...
(2, '2022_04_03_105429_create_usersses_table', 1),
(3, '2022_04_03_105455_create_departments_table', 1),
(4, '2022_04_03_105515_create_designations_table', 1);
...
ALTER TABLE `usersses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `usersses_phone_unique` (`phone`);
